...
public interface SerieRepository extends JpaRepository<Serie, Long >{
    ...
    @Query("SELECT e FROM Serie s JOIN s.episodios e WHERE s = :serie AND YEAR(e.dataLancamento) >= :dataEscolhida")
    List<Episodio> buscarPorData(Serie serie, int dataEscolhida);
}
